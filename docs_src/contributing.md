...
Contributions may take multiple forms: **code** and **documentation** of cource, but not only. Any help on **communication** and **structuring the project** and the **community** would be very much appreciated. This project intends to unite a lot of people to have a lot of impact.
### Contact
