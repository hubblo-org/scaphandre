use crate::exporters::*;
use crate::sensors::{Topology, Sensor, RecordGenerator};
...
impl Warp10Exporter {
    ...
    pub fn iteration(&mut self, host: &str, scheme: &str, port: u16, write_token: &str) -> Result<warp10::Response, warp10::Error> {
        ...
        if let Some(metric_value) = self.topology.get_process_cpu_consumption_percentage(
